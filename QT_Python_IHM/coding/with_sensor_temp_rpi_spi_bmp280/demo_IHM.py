...
class Monitoring(QWidget):
    ...
    def setTempval(self, val):
        self.Pstatus.setValue(val)
    def setPressionval(self,val):
        #self.Hstatus.setMaximum(1000)
    ...
    #définissons et positionnons les objets présents sur l'onglet infos
        ...
        self.thermo=thermo()
        self.Plabel=QLabel('Temperature')
        self.Hlabel=QLabel('Pression')
        self.RSSIlabel=QLabel('Altitude')
    ...
    def affiche(self):
        ...
        #self.setTempval(int(self.Sensor.get_Temperature(self)))
        self.setTempval(Sensor.get_Temperature(self))
        self.setPressionval(Sensor.get_Pressure(self)/100)
        self.setAltitude(int(Sensor.get_Altitude(self)/100))
        temp=Sensor.get_Temperature(self)
        self.setTemp(temp)#temperature moyenne des CPU
